...
RUN cd /usr/bin \
    && python3 -c \
        'from requests import get; import sys; sys.stdout.buffer.write(get("https://github.com/gohugoio/hugo/releases/download/v0.96.0/hugo_0.96.0_Linux-64bit.tar.gz").content)' \
        | tar -xz hugo
